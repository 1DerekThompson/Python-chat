...
HOST = gethostname()
PORT = 8011
# For conn you have to type in your IP address. I would recommend going through IPv4 address and typing that IP address in.
conn = ''
s.bind((HOST, PORT))
...
def Sound_1(): # this is my function for my button to function to play a sound.
    pygame.init()
    pygame.mixer.init()
    pygame.mixer.music.load("miku.wav")
...
Soundplayer = Button(base, font=30, text="miku", width="12", height=5, bd=0, bg= "Red", activebackground="White",
                     command=Sound_1)
...
Soundplayer.place(x=6, y=441, height=30) # Placing the button in the application.
