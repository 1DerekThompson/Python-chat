...
def Sound_2():
    pygame.init()
    pygame.mixer.init()
    pygame.mixer.music.load("power.wav")
...
Soundplayer_2 = Button(base, font=30, text="ranger", width="12", height=5, bd=0, bg= "Red", activebackground="White",
                     command=Sound_2)
...
Soundplayer_2.place(x=6, y=441, height=30)
